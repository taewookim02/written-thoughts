...
public class ListItemService {
    ...
    public ListItemDto create(ListItemDto dto, Principal connectedUser) throws AccessDeniedException {
        ...
        // if user tries to add list item to another persons' list, throw error
